...
function OrganizerAuthoring({
  ...
  async function assignReviewers(): Promise<void> {
    ...
    try {
      ...
      setAssignmentPreview(`${result.assignments.length} reviewer assignment(s) persisted.`);
              ...
              {reviewerMembersLoading
                ...
                : (reviewerMembersError ??
                  (reviewerMembers.length === 0
                    ...
                    : "Select the reviewers who should receive this assignment."))}
            </span>
          </div>
        </div>
        <Button type="button" variant="outline" onClick={previewAssignments} disabled={busy}>
          Preview assignments
        </Button>
        {assignmentPreview ? (
                  ...
                  <tr key={assignment.id}>
                    ...
                    <td>
                      <button
                        ...
                        aria-label={`Unassign ${reviewer} from ${submissionTitle}`}
                      >
