...
export default async function CfpParticipantsPage({ params }: CfpPageProps) {
  const { organizationId, eventSlug } = await params;
  return <CfpWizard organizationId={organizationId} eventSlug={eventSlug} step="participants" />;
}
