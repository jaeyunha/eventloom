...
CREATE UNIQUE INDEX evaluation_suggestions_shared_scope_unique ON evaluation_suggestions (organization_id, event_id, plan_id, round_id, submission_id) WHERE assignment_id IS NULL;
