...
export const TABLE_DEFINITIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      link("Predecessor Assignment", "Review Assignments", "Preceding assignment in replacement lineage."),
      text("Successor Assignment ID", "Replacement assignment created from this assignment."),
      link("Successor Assignment", "Review Assignments", "Following assignment in replacement lineage."),
  ...
  },
  {
    ...
    fields: [
      ...
      ...organizationScopeFields(),
      ...eventScopeFields(),
      text("Agenda Revision ID", "Immutable agenda revision application ID served by this release."),
      link("Agenda Revision", "Agenda Versions", "Immutable agenda revision served by this release."),
      text("Speaker Revision ID", "Immutable speaker projection revision application ID served by this release."),
      link(
        "Speaker Revision",
