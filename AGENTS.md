...
- Advisory AI is optional and provider-backed (Workers AI in current deployments; OpenAI Responses when explicitly configured). A human must apply, edit, or reject every consequential suggestion. Provider configuration is not feature-verification evidence.
